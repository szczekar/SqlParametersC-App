...
namespace BazaDanych
{
    public class User
    {
        ...
        public static void openCloseDBconnection(string value,Dictionary<string,object> keyValuePairs)
        {
            ...
            {
                //SqlCommand sqlCommand = new SqlCommand(value, connection);
        ...
        public void Add()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    string newNameAndPassword = String.Format("INSERT INTO dbo.Users(Name,MyPassword) VALUES (@Name,@MyPassword)");
            ...
            try
            {
                if (!String.IsNullOrWhiteSpace(this.Name))
                {
                    // string userToDelete = string.Format("DELETE FROM dbo.Users WHERE Name = '" + this.Name + "' ");
                     string userToDelete = string.Format("DELETE FROM dbo.Users WHERE Name = @Name");
        ...
        public static void Update(User user1, User user2)
        {
           ...
           // dict.Add("@Password1", user1.Password);

            dict.Add("@Name2", user2.Name);
           // dict.Add("@Password2", user2.Password);
            ...
            try
            {
                ...
                else
                {
                    ...
                    string userToUpdate = string.Format("UPDATE dbo.Users SET Name = @Name2 WHERE Name = @Name1");
